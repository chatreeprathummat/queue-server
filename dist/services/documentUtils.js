...
exports.resetMonthlyRunningNumber = resetMonthlyRunningNumber;
exports.getCurrentRunningNumber = getCurrentRunningNumber;
exports.parseDocumentNumber = parseDocumentNumber;
exports.validateDocumentNumber = validateDocumentNumber;
exports.generateSimpleDocumentNumber = generateSimpleDocumentNumber;
// Import with require for modules without type declarations
const docMoment = require('moment-timezone');
/**
 ...
 */
async function generateDocumentNumber(connection, prefix) {
    try {
 ...
 */
async function resetMonthlyRunningNumber(connection, prefix) {
    try {
        const now = docMoment().tz('Asia/Bangkok');
 ...
 */
async function getCurrentRunningNumber(connection, prefix) {
    try {
        const now = docMoment().tz('Asia/Bangkok');
 ...
 * @returns boolean
 */
function validateDocumentNumber(documentNumber, expectedPrefix) {
    try {
 ...
 * @returns string
 */
function generateSimpleDocumentNumber(prefix) {
    const now = docMoment().tz('Asia/Bangkok');
